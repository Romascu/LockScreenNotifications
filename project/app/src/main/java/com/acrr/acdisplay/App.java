...
import com.acrr.acdisplay.notifications.NotificationHelper;
import com.acrr.acdisplay.notifications.NotificationPresenter;
import com.acrr.acdisplay.permissions.AccessManager;
import com.acrr.acdisplay.services.KeyguardService;
import com.acrr.acdisplay.services.SensorsDumpService;
import com.acrr.acdisplay.services.activemode.ActiveModeService;
import com.acrr.base.AppHeap;
import com.acrr.base.content.ConfigBase;
import com.acrr.base.interfaces.IConfiguration;
import com.acrr.base.permissions.Permission;
import com.acrr.base.permissions.PermissionGroup;
import com.acrr.base.utils.RawReader;
import com.acrr.base.utils.smiley.SmileyParser;
...
public class App extends Application {
    ...
    public static final String ACTION_BIND_MEDIA_CONTROL_SERVICE = "com.acrr.acdisplay.BIND_MEDIA_CONTROL_SERVICE";

    public static final String ACTION_ENABLE = "com.acrr.acdisplay.ENABLE";
    public static final String ACTION_DISABLE = "com.acrr.acdisplay.DISABLE";
    public static final String ACTION_TOGGLE = "com.acrr.acdisplay.TOGGLE";
    public static final String ACTION_ACTIVE_MODE_ENABLE = "com.acrr.acdisplay.ACTIVE_MODE_ENABLE";
    public static final String ACTION_ACTIVE_MODE_DISABLE = "com.acrr.acdisplay.ACTIVE_MODE_DISABLE";
    public static final String ACTION_ACTIVE_MODE_TOGGLE = "com.acrr.acdisplay.ACTIVE_MODE_TOGGLE";

    public static final String ACTION_STATE_START = "com.acrr.acdisplay.STATE_START";
    public static final String ACTION_STATE_RESUME = "com.acrr.acdisplay.STATE_RESUME";
    public static final String ACTION_STATE_PAUSE = "com.acrr.acdisplay.STATE_PAUSE";
    public static final String ACTION_STATE_STOP = "com.acrr.acdisplay.STATE_STOP";

    public static final String ACTION_EAT_HOME_PRESS_START = "com.acrr.acdisplay.EAT_HOME_PRESS_START";
    public static final String ACTION_EAT_HOME_PRESS_STOP = "com.acrr.acdisplay.EAT_HOME_PRESS_STOP";
