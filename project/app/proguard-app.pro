...
-keep public class com.acrr.acdisplay.ui.fragments.settings.** extends android.app.Fragment

# Keep Xposed modules, cause they're predefined in /assets/xposed_init
-keep public class com.acrr.acdisplay.plugins.xposed.**

# Keep Config methods to be able to access them using reflections.
-keepclassmembers public class com.acrr.acdisplay.Config {
   *;
}
